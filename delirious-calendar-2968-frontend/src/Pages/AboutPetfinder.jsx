...
export const AboutPetfinder = () => {
  ...
  return (
    <div
      style={{ background: "#EDE7F6", paddingTop: "50px" }}
    ...
    >
      ...
      >
        ...
        <a style={{ marginRight: "20px" }} href="">
          Adopt or Get Involved <ChevronRightIcon />
        </a>
          ...
          <Collapse startingHeight={20} in={show}>
            <Box textAlign="left" ml="7%" fontFamily={"Cairo, sans-serif"}>
              <p>
                ...
                and adoption organizations across the U.S., Canada, and Mexico.
              ...
              <p>
                ...
                like to help, let us know! You can find us
                <br />
                <br />
                at{" "}
                ...
                Email: <a href="pets@petfinder.com.">pets@petfinder.com.</a>
                <br />
                <br />
        ...
        <div style={{ display: "flex", width: "95%", margin: "auto" }}>
          ...
          >
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://www.petfinder.com/static/3dd7d912ce48e5d7e4d38e38d0465bdd/3d0f7/DownloadApp_TopImage.webp"
                }
                dis={"ABOUTPETFINDER"}
                data={"Download the pet finder App today!"}
              />
            </div>
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://www.petfinder.com/static/fc8892765d68b0a629d732cb0a9c561d/154e9/WPPf-hero-632x379.webp"
                }
                dis={"ABOUTPETFINDER"}
                data={"Powered by Purnia. Driven by Pets & There people"}
              />
            </div>
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5sLn5Nrc9ZMIPUYo20fsLbwZtVUzkGC7v8Ml5Phb07FVbir5mOHffKGgrF07f0jW-iWY&usqp=CAU"
                }
                dis={"ABOUTPETFINDER"}
                data={"Petsfinder Mission"}
              />
            </div>
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://www.petfinder.com/static/1f7f8a66e2689008fdb0aff834abd255/af4b6/cat-new-search-launch-woah-632x632.webp"
                }
                dis={"ABOUTPETFINDER"}
            ...
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMQ3cn77-UW7ivj4YtY9G_Pcik7Ef7FcVb1sAkxCzQ2uf07QCkBLPPoANrVaPIIJTy2Hs&usqp=CAU"
                }
                dis={"ABOUTPETFINDER"}
      ...
      <div className="nearby-pets">
        ...
        >
          Pets avilable for Adoption Nearby
        </h1>
        <div>
          <div className="nearby-pets-list">
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55063999/1/?bust=1683800930&width=316"
                }
                data={"Scooby"}
              />
            </div>
            <div style={{ marginRight: "10px" }}>
              <ProductSimple
                image={
                  "https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/63947579/1/?bust=1683303760&width=316"
                }
                data={"Crunch"}
              />
            </div>
