...
export const AdminHomePage = () => {
  ...
  let getPostData = () => {
    axios
      .get(" http://localhost:8080/admin/forms")
      .then((res) => {
  ...
  let handleBlockUSer = (id) => {
    axios
      .post(` http://localhost:8080/admin/block/${id}`)
      .then((res) => {
        getUserData();
        toast({
  ...
  let getDogsData = () => {
    axios
      .get(` http://localhost:8080/dogs/get?page=${currentPage}&limit=10`)
      .then((res) => {
  ...
  let getCatsData = () => {
    axios
      .get(` http://localhost:8080/cats/get?page=${page}&limit=10`)
      .then((res) => {
  ...
  const DeleteDogsData = (id) => {
    axios.delete(` http://localhost:8080/dogs/delete/${id}`).then((res) => {
      toast({
        title: "Data Deleted",
        status: "error",
        duration: 2000,
  ...
  const DeleteCatsData = (id) => {
    axios.delete(` http://localhost:8080/Cats/delete/${id}`).then((res) => {
      toast({
        title: "Data Deleted",
        status: "error",
        duration: 2000,
  ...
  let handleReject = (id) => {
    axios.delete(` http://localhost:8080/post/delete/${id}`).then((res) => {
      toast({
  ...
  let handleApprove = (id) => {
    axios.patch(` http://localhost:8080/post/patch/${id}`).then((res) => {
      toast({
